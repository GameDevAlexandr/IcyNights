...
public class RabbitNav : MonoBehaviour
{
 //   [SerializeField] private ParticleSystem step;
    ...
    IEnumerator SpawnWait()
    {
        ...
        _prefabTargetTransform = Instantiate(_prefabTarget, new Vector3(transform.position.x + (Random.Range(-15f, 15f)),
           transform.position.y, transform.position.z + (Random.Range(-15f, 15f))), Quaternion.identity);
